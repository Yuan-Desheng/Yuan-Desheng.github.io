...
<span class="line"><span>        ])</span></span>
<span class="line"><span>  ]</span></span>
<span class="line"><span>}</span></span></code></pre></div><ol start="4"><li>需要在public/index.html 引入EasyPlayer-lib.min.js 可以直接在node_modules里找到@easydarwin下的dist/compent/EasyPlayer-lib.min.js 复制到pubilc目录下,还有需要EasyPlayer.wasm同样放到public目录下</li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>   &lt;script src=&quot;./EasyPlayer-lib.min.js&quot;&gt;&lt;/script&gt;</span></span></code></pre></div><ol start="5"><li>在vue中使用</li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>   &lt;easy-player video-url=&quot;http://www.jxwwpt.com/hdl/stream/jxsb01.flv&quot; :live=&quot;true&quot;&gt;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>import EasyPlayer from &#39;@easydarwin/easyplayer&#39;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>components: { EasyPlayer },</span></span></code></pre></div><ol start="6"><li>绑定回调事件</li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;easy-player  </span></span>
...
<span class="line"><span>},</span></span></code></pre></div>`,24)]))}const h=s(l,[["render",t]]);export{y as __pageData,h as default};
